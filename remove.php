...
<?php
    ...
    $sql = "SELECT * FROM cart WHERE userid='$userid' AND img='$tt'";
    ...
    $resultcheck = mysqli_num_rows($result);
        ...
        $price = $row['price'];
            echo "<center>";
            echo "<div style='font-size:50px; color:#a64ac9'> The following book has been removed  from the cart<br><br> </div>";
                echo'<div class="card">
                        <div class="image">
                ...
                if (!$conn -> query("DELETE FROM  cart WHERE userid='$userid' AND img='$tt'") )
                {
